...
const DEMO_ROLES: { id: string; label: string; role: Role; desc: string }[] = [
  ...
  { id: "u_rec", label: "Meera Sundar", role: "reception", desc: "Brookfields Flagship reception" },
  { id: "u_brm", label: "Karthik Raja", role: "branch_manager", desc: "Brookfields Flagship manager" },
